      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <Reveal>
          ...
          <p className="mt-5 text-base leading-9 text-brand-ink/75 md:text-lg">
            ...
            والصيانة والعزل ومكافحة الحشرات وحلول الصرف الصحي وما يرتبط بها من خدمات
        ...
        <Reveal delay={150} className="relative">
          ...
          <div className="relative overflow-hidden rounded-[2rem] shadow-lift">
            <Image
              src="https://raw.githubusercontent.com/ziadelkady20-blip/el-mas3ody/main/images/image%206.png?v=0e5c71cdc55ac1221e0c26db53571a037a5da389"
