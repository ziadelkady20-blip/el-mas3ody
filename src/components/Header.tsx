  ...
  return (
    ...
    >
      <div className="relative mx-auto flex max-w-7xl items-center justify-center gap-4 px-4 py-2 sm:px-6 lg:px-8">
        <a href="#about" className="absolute right-4 top-1/2 hidden -translate-y-1/2 items-center rounded-full border border-accent/30 bg-white/80 px-4 py-2 shadow-sm backdrop-blur transition-all hover:border-accent/60 hover:bg-white hover:-translate-y-[55%] lg:flex">
      ...
      >
        <nav aria-label="قائمة الجوال" className="px-4 py-4 sm:px-6">
          <a href="#about" onClick={() => setOpen(false)} className="mb-3 block rounded-2xl border border-accent/25 bg-white/70 px-4 py-3 text-center transition-colors hover:bg-white">
            <p className="text-sm font-bold text-brand">خبرة منذ 32 سنة في الرياض</p>
          </a>
